...
class Parameters:
    def __init__(self):
        ...
        self.p = {  's_TimePuskTest_1': Parameter('s_TimePuskTest_1', 100, 'WSTRING(16)', 'Время пуска испытания 1'),
                    ...
                    's_FileNameTest_1': Parameter('s_FileNameTest_1', 140, 'WSTRING(16)', 'Имя файла с архивом 1'),
                    's_FileNameTestEnd_1': Parameter('s_FileNameTestEnd_1', 160, 'WSTRING(16)', 'Имя файла с архивом 1'),
                    ...
                    's_FileNameTest_2': Parameter('s_FileNameTest_2', 250, 'WSTRING(16)', 'Имя файла с архивом 2'),
                    's_FileNameTestEnd_2': Parameter('s_FileNameTestEnd_2', 270, 'WSTRING(16)', 'Имя файла с архивом 2'),
                    ...
                    's_FileNameTest_3': Parameter('s_FileNameTest_3', 360, 'WSTRING(16)', 'Имя файла с архивом 3'),
                    's_FileNameTestEnd_3': Parameter('s_FileNameTestEnd_3', 380, 'WSTRING(16)', 'Имя файла с архивом 3'),
